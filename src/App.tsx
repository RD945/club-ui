              ...
              {filteredClubs.map((club) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 relative">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          className={`px-6 py-2 rounded-lg text-sm font-semibold transition-all duration-200 w-full sm:w-auto ${
                    ...
                    {/* City name positioned 10px from bottom */}
                    <div className="absolute bottom-2.5 left-5 flex items-center gap-1 text-sm text-gray-500">
            ...
            {myClubs.length > 0 ? (
              <div className="space-y-4">
                ...
                {myClubs.map((club) => (
                  <div
                    key={club.id}
                    className="bg-white/80 backdrop-blur-lg rounded-xl p-5 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-200 relative"
                  >
